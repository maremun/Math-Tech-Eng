...
%	\newpage
	...
	\begin{itemize}
		...
		\examplesentence{Machine translation (MT) is hard. Translation deals with natural language which is incredibly rich \dots}
		...
		\examplesentence{We tested the proposed model and got such and such results. \dots}
		\item Here's how my idea compares to other approaches 
		
		\examplesentence{A seminal paper on MT is by Green et al. [1]. It lays the foundation for the work we have done. \dots Blue et al. [2] use very similar approach, however \dots}
	\end{itemize}
	...
	Avoid ``the rest of the paper is structured as follows\dots'' part. Do you ever read it yourself? The structure is given by the forward-references already!
